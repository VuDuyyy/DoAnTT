...
<head>
  ...
  <title>Admin - Quản Lý Đặt Tour</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Đặt Tour</h1>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Quản Lý Đặt Tour</h6>
                  <?php if($error){?>
                    <div class="errorWrap">
                      ...
                      foreach($results as $result)
                        {       ?>    
                          <tr>
                            ...
                            {
                              echo "Đã hủy bởi bạn  " .$result->upddate;
                            } 
                            if($result->status==2 and $result->cancelby=='u')
                            {
                              echo "Người dùng đã hủy  " .$result->upddate;
                            ...
                            {?>
                              ...
                              <td>
                                <a href="manage_bookings.php?bkid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Bạn có thực sự muốn hủy đặt phòng không')" >Hủy</a>&nbsp;<a href="manage_bookings.php?bckid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Bạn có thực sự muốn xác nhận đặt phòng không')" >Xác nhận</a>
                              </td>
                              <?php 
                            }?>
