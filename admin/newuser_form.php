...
if(!empty($_POST["fullname"])) {
  ...
  if($query -> rowCount() > 0)
  {
    echo "<script>alert('Tên đăng kí đã được sử dụng. thử một cái tên khác');</script>";
} else{
        ...
        <div class="row ">
            <div class="form-group col-md-6">
                <select class="form-control"   name="dignity"  id="dignity"  required>
                    <option value="">Chọn tư cách</option>
            ...
            <div class="form-group col-md-6">
                <input type="text" class="form-control" name="staffid" placeholder=" ID" required="required">
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-6">
                <input type="text" class="form-control" name="fullname" id="fullname" placeholder="Tên Sử Dụng" onBlur="checkAvailability2()" required="required">
