...
<head>
  ...
  <title>Admin - Đăng Ký Người Dùng</title>
              ...
              <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  ...
                  <div class="card-tools" style="float: right;">
                    <button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#delete" ></i> Xóa  
                    </button>
                  ...
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    <thead>
                      <tr>
                        ...
                        <th class="text-center" style="width: 15%;">Hoạt Động</th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php
                      ...
                      if($query->rowCount() > 0)
                      {
                        ...
                        {    
                          ...
                          <tr>
                            ...
                            <td class=" text-center">
                              <a href="#"  class=" edit_data  btn btn-sm btn-primary" id="<?php echo  ($row->ID); ?>" title="click for edit" >Chỉnh sửa</a>
                              <a href="user_register.php?delid=<?php echo ($row->ID);?>" onclick="return confirm('Do you really want to Delete ?');" title="Delete this User" class="btn btn-sm btn-danger">Xóa</a> </td>
                            </tr>
                            <?php $cnt=$cnt+1;
                          }
                        } ?>
