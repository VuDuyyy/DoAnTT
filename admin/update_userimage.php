...
if (strlen($_SESSION['odmsaid']==0)) 
{
  ...
  <head>
    ...
    <title>Admin - Cập Nhật Thông Tin</title>
          ...
          <div class="container-fluid" id="container-wrapper">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              ...
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Cập Nhật Hình Ảnh Người Dùng</li>
              </ol>
            </div>
                    ...
                    if($query->rowCount() > 0)
                    {
                      foreach($results as $row)
                      {
                        ...
                        <div class="control-group">
                          <label class="control-label" for="basicinput">Tên Người Dùng</label>
                          <div  class="col-6">
                        ...
                        <div class="control-group"> 
                          ...
                          <div class="controls">
                            ...
                            { 
                              ?>
                              <img src="profileimages/<?php  echo $row->Photo;?>" width="370" height="350"> 
                              <?php
                            } ?> 
                          </div>
                        </div>
