...
<head>
  ...
  <title>Admin - Cập Nhật Thông Tin Người Dùng</title>
                            ...
                            <div class="p-3 py-5">
                              ...
                              <div class="row mt-3">
                                <div class="col-md-6">
                                 ...
                                 <div class="mt-5 text-right"><button class="btn btn-primary profile-button" type="submit" name="submit">Cập nhật</button></div>
                               </div>
                             </div>
                           </div>
                         </div>
