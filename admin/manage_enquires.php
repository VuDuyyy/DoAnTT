...
<head>
  ...
  <title>Admin - Quản lý các yêu cầu</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Yêu cầu</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="dashboard.php">Trang chủ</a></li>
              <li class="breadcrumb-item active" aria-current="page">Quản lý các yêu cầu</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Quản lý các yêu cầu</h6>
                  <?php if($error){?>
                    <div class="errorWrap">
                      ...
                      if($query->rowCount() > 0)
                      {
                        ...
                        {       
                          ...
                          <tr>
                            ...
                            {
                              ?>
                              <td><a href="manage_enquires.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Bạn có thực sự muốn đọc')" >Chưa giải quyết</a>
                              </td>
                              <?php 
                            } ?>
