...
{ 
  ...
  <head>
    ...
    <title>My Travel -Đổi Mật Khẩu</title>
    ...
    <div class="privacy">
      <div class="container">
        ...
        <form name="chngpwd" method="post" onSubmit="return valid();">
          ...
          <p style="width: 350px;">
            <b>Mật Khẩu Cũ</b>  <input type="password" name="password" class="form-control" id="exampleInputPassword1" placeholder="" required="">
          </p> 
          ...
          <p style="width: 350px;">
            <button type="submit" name="submit5" class="btn-primary btn">Đổi</button>
          </p>
        </form>
      </div>
    </div>
